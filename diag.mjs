#!/usr/bin/env node
// S.O.N Diagnostic — run this to find out why server.mjs fails silently
// Usage: node diag.mjs

console.log('=== S.O.N DIAGNOSTICS ===\n');
...
try {
  ...
  if (err.code === 'EADDRINUSE') {
    ...
    console.error('   A previous S.O.N instance may still be running.');
